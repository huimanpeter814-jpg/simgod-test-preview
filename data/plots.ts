...
const PLOT_APT_SMALL: PlotTemplate = {
    ...
    rooms: [
        { 
            id: 'r_main', x: 10, y: 10, w: 280, h: 280, 
            label: '温馨小屋', color: '#fff', pixelPattern: 'wood',
            hasWall: true // ✅ 新增墙壁
        }
    ],
    furniture: [
...
const PLOT_VILLA_WIDE: PlotTemplate = {
    ...
    rooms: [
        { id: 'garden', x: 0, y: 0, w: 500, h: 350, label: '', color: PALETTE.plant_green, pixelPattern: 'grass_dense' }, // 户外无墙
        { 
            id: 'house', x: 20, y: 20, w: 300, h: 310, 
            label: '主楼', color: '#fff', pixelPattern: 'pave_fancy',
            hasWall: true // ✅ 新增墙壁
        },
...
const PLOT_DORM_STD: PlotTemplate = {
    ...
    rooms: [
        { 
            id: 'dorm_r', x: 10, y: 10, w: 380, h: 280, 
            label: '集体宿舍', color: '#f5f6fa', pixelPattern: 'tile',
            hasWall: true // ✅ 新增墙壁
        }
    ],
    furniture: [
...
const PLOT_ELDER_CARE: PlotTemplate = {
    ...
    rooms: [
        ...
        { 
            id: 'care_center', x: 20, y: 20, w: 300, h: 360, 
            label: '疗养中心', color: '#f0fdf4', pixelPattern: 'wood',
            hasWall: true // ✅ 新增墙壁
        },
        { 
            id: 'clinic', x: 340, y: 20, w: 140, h: 150, 
            label: '医务室', color: '#fff', pixelPattern: 'tile',
            hasWall: true // ✅ 新增墙壁
        }
    ],
    furniture: [
...
// [科技总部] - (600x300)
// 修改：缩小房间尺寸以留出边距，并添加 hasWall
const PLOT_TECH_HQ: PlotTemplate = {
    id: 'tech_hq', width: 600, height: 300, type: 'work',
    rooms: [
        { 
            id: 'tech_f', x: 5, y: 5, w: 590, h: 290, // 👈 留出 5px 边距
            label: '研发中心', color: '#ecf0f1', pixelPattern: 'grid',
            hasWall: true 
        },
        { 
            id: 'server_room', x: 480, y: 20, w: 100, h: 260, 
            label: '机房', color: '#2c3e50', pixelPattern: 'stripes',
            hasWall: true
        }
    ],
    furniture: [
...
const PLOT_MALL_WIDE: PlotTemplate = {
    ...
    rooms: [
        { 
            id: 'mall_f', x: 5, y: 5, w: 590, h: 290, // 👈 边距
            label: '购物中心', color: '#ffeaa7', pixelPattern: 'mall',
            hasWall: true 
        }
    ],
    furniture: [
...
const PLOT_DESIGN_V: PlotTemplate = {
    ...
    rooms: [
        { 
            id: 'studio', x: 5, y: 5, w: 340, h: 440, 
            label: '画室', color: '#fff9e8', pixelPattern: 'wood',
            hasWall: true 
        }
    ],
    furniture: [
...
// [健身房] - (350x450)
// 修改：缩小房间尺寸，添加 hasWall
const PLOT_GYM: PlotTemplate = {
    id: 'gym', width: 350, height: 450, type: 'commercial',
    rooms: [
        { 
            id: 'gym_floor', x: 5, y: 5, w: 340, h: 440, 
            label: '健身大厅', color: '#2d3436', pixelPattern: 'tile',
            hasWall: true 
        },
        { 
            id: 'locker', x: 250, y: 0, w: 100, h: 150, 
            label: '更衣室', color: '#636e72', pixelPattern: 'simple',
            hasWall: true 
        }
    ],
    furniture: [
...
const PLOT_NIGHTCLUB: PlotTemplate = {
    ...
    rooms: [
        { 
            id: 'club_floor', x: 5, y: 5, w: 390, h: 390, 
            label: '舞池', color: '#2d3436', pixelPattern: 'stripes',
            hasWall: true
        }
    ],
    furniture: [
...
// [医院] - (500x400)
// 修改：大厅缩小边距，添加 hasWall
const PLOT_HOSPITAL_L: PlotTemplate = {
    id: 'hospital_l', width: 500, height: 400, type: 'public',
    rooms: [
        { 
            id: 'hall', x: 5, y: 5, w: 490, h: 390, 
            label: '门诊部', color: '#f5f6fa', pixelPattern: 'tile',
            hasWall: true 
        },
        { 
            id: 'ward', x: 350, y: 20, w: 130, h: 360, 
            label: '住院区', color: '#81ecec', pixelPattern: 'simple',
            hasWall: true 
        }
    ],
    furniture: [
...
// [学校组合] - (600x400)
// 修改：教学楼添加 hasWall，操场保持开放
const PLOT_SCHOOL_L: PlotTemplate = {
    id: 'school_l', width: 600, height: 400, type: 'public',
    rooms: [
        { 
            id: 'class_zone', x: 20, y: 20, w: 300, h: 360, 
            label: '教学楼', color: '#dff9fb', pixelPattern: 'wood',
            hasWall: true 
        },
...
// [小服务店] - (200x200)
// 修改：房间缩小边距，添加 hasWall
const PLOT_SHOP_S: PlotTemplate = {
    id: 'shop_s', width: 200, height: 200, type: 'commercial',
    rooms: [
        { 
            id: 's_r', x: 5, y: 5, w: 190, h: 190, 
            label: '便利店', color: '#fff', pixelPattern: 'tile',
            hasWall: true 
        }
    ],
    furniture: [
